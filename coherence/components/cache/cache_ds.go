...
// Return a new CacheDs struct based on the given parameters.
...
func NewCacheDs(blockSize, associativity, cacheSize int) CacheDs {
...
// otherwise return -1.
func (cacheDs *CacheDs) GetIndexInArray(address uint32) int {
...
func (cacheDs *CacheDs) Contain(address uint32) bool {
...
func (cacheDs *CacheDs) Insert(address uint32) (bool, uint32) {
...
func (cacheDs *CacheDs) Access(address uint32) bool {
...
func (cacheDs *CacheDs) GetTag(address uint32) uint32 {
	return address >> (cacheDs.setIndexNumBits + cacheDs.offsetNumBits)
}

// Return the set index of the given address.
func (cacheDs *CacheDs) GetCacheSetIndex(address uint32) uint32 {
...
func (cacheDs *CacheDs) getAbsoluteIndex(address uint32, round int) uint32 {
